...
function initContactForm() {
    ...
    form.addEventListener('submit', (event) => {
        ...
        const subject = data.get('subject') || 'Contact form';
        ...
        if (!ownerEmail) {
            alert('Thank you! Please contact the site owner directly.');
            form.reset();
            return;
        }
        ...
        window.location.href = `mailto:${ownerEmail}?subject=${mailSubject}&body=${body}`;
        form.reset();
    });
}
