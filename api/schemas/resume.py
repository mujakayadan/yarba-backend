...
class ResumeCreate(BaseModel):
    ...
    job_description_url: str | None = Field(
...
class ResumeUpdate(BaseModel):
    ...
    content: dict[str, Any] | None = Field(None, description="Resume content")
    resume_pdf_key: str | None = Field(None, description="S3 key for the resume PDF")
...
class ResumeFilter(BaseModel):
    ...
    is_cover_letter: bool | None = Field(None, description="Filter by document type")
