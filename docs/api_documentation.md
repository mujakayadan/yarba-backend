  ...
  "work_experience": [
    {
      ...
      "end_date": "YYYY-MM (optional; null for current jobs)",
      "current": "boolean",
...
Work experience is validated at month granularity and returned newest-to-oldest.
`time` is generated by the API from the structured dates for display.
