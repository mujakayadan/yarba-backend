...
class SkillsProcessor(SectionProcessor):
    ...
    def process(self, content: Any) -> str:
        """
        Process skills into LaTeX content with complete section formatting.

        Args:
            content: Skills data

        Returns:
            Complete LaTeX content for skills section
        """
        # Parse the content
        ...
        if isinstance(data, str):
            ...
            skills_content = sanitize_latex(data)
        else:
            result = []
                    ...
                    for category in data["skills"]:
                        if isinstance(category, dict):
                            ...
                            if category_name and skills_list:
                                # Add skill item with proper format
                                result.append(
            ...
            if not result and data:
                ...
                result.append(
                    "\\resumeSkillHeading{Technical Skills}{Placeholder skills}"
                )

            skills_content = "\n".join(result)

        # Return the fully formatted skills section
