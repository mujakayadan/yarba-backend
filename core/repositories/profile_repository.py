...
class ProfileRepository(BeanieRepository[Profile]):
    ...
    def _ensure_object_id(self, id_value: Any) -> ObjectId | None:
    ...
    async def update_by_object(self, profile: Profile) -> Profile | None:
    ...
    async def get_by_user(self, user: User) -> Profile | None:
    ...
    async def get_by_user_id(self, user_id: Any) -> Profile | None:
    ...
    async def exists(self, profile_id: str | PydanticObjectId | ObjectId) -> bool:
    ...
    async def get_user(self, profile_id: str) -> User | None:
    ...
    async def create_for_user(
        self, user: User, email: EmailStr, full_name: str | None = None
    ) -> Profile | None:
    ...
    async def update_llm_usage(
        ...
        try:
            ...
            profile.llm_usage.usage_by_operation[operation_type]["tokens"] += (
                tokens_used
            )
    ...
    async def get_llm_usage(
        self, user_id: str | PydanticObjectId
    ) -> dict[str, Any] | None:
    ...
    async def reset_current_month_usage(self, user_id: str | PydanticObjectId) -> bool:
