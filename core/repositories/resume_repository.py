...
class ResumeRepository(BeanieRepository[Resume]):
    ...
    async def get_user(self, resume_id: PydanticObjectId) -> User | None:
    ...
    ) -> tuple[User | None, Profile | None, Portfolio | None]:
    ...
    async def get_latest_by_user(self, user: User) -> Resume | None:
    ...
    async def get_latest_by_user_id(self, user_id: PydanticObjectId) -> Resume | None:
