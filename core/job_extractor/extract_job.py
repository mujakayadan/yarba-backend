...
class JobExtractor:
    ...
    async def extract_from_url(self, url: str) -> Optional[JobDetails]:
        """
        ...
        try:
            result: Optional[JobDetails] = await self.manager.extract(url)
    ...
    async def extract_and_save(
        ...
        job_details_data: Optional[JobDetails] = None,
    ) -> Optional[JobDetails]:
        """
