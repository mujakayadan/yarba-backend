...
class JobService:
    ...
    def __init__(
        ...
        job_extractor: JobExtractor | None = None,
    ):
    ...
    async def extract_job_details_from_url(self, url: str) -> JobDetails | None:
    ...
    def check_job_restrictions(
        self,
        job_description: str,
        user_has_clearance_check_enabled: bool | None = None,
    ) -> bool:
