...
class LLMService:
    ...
    def __init__(
        ...
        self.current_resume_id: PydanticObjectId | None = None
        self.current_cover_letter_id: PydanticObjectId | None = None
    ...
    def model_supports_json_schema(self, model: str | None = None) -> bool:
    ...
    async def check_usage_limits(self, user_id: str | None) -> dict[str, Any]:
    ...
    async def get_structured_completion(
        ...
        user_id: str | None = None,
        tags: list[str] | None = None,
    ) -> tuple[BaseModel | str, litellm.ModelResponse | None]:
        ...
        except ValueError as ve:  # Catch specific ValueErrors like usage limits or parsing errors from above
