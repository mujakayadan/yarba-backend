...
class ProfileService:
    ...
    async def get_signature_key(self, user_id: PydanticObjectId) -> str | None:
    ...
    async def get_signature_url(self, user_id: PydanticObjectId) -> str | None:
    ...
    async def get_profile_picture_url(self, user_id: PydanticObjectId) -> str | None:
